...
def login():
    ...
    if form.validate_on_submit():
        ...
        app.logger.info('User logged in successfully: {}'.format(form.username.data))
...
def authorized():
    ...
    if request.args.get('code'):
        ...
        app.logger.info('User logged in successfully via Microsoft: {}'.format(session["user"].get("name")))
        _save_cache(cache)
    return redirect(url_for('home'))
